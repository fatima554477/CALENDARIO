<div id="content">     
			<hr/>
		<strong>	  <p class="mb-0 text-uppercase" ><img src="includes/contraer31.png" id="mostrar6" style="cursor:pointer;"/>
<img src="includes/contraer41.png" id="ocultar6" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp; CRONOLOGICO DE TRANSPORTACIÓN TERRESTRE</p></strong></div>
