...
$_SESSION['id'] = $_SESSION['idem'];
	...
	require "pagoproveedores/controladorPP.php";
	require "pagoproveedores/variablesPP.php";
    ...
    <div class="wrapper">
     ...
     <!--end sidebar -->
        ...
        <!--start top header-->
		  ...
		  <?php require "pagoproveedores/notificaciones2.php"; /*php notificaciones*/ ?>
          </header>
        <!--end top header-->
        ...
        <div class="page-content-wrapper">
         ...
         <div class="page-content">
		  ...
		  <?php require "pagoproveedores/mapeo1.php"; /*php mapa*/ ?>
          </div>
          <!--end breadcrumb
...
<?php
 ...
 require "pagoproveedores/expansores.php";
// require "pagoproveedores/PAGO_PROVEEDOR1.php";
// require "pagoproveedores/DATOS_BANCARIOS_1.php";
 require "pagoproveedores/fetch_page_nuevo.php";
...
<!--NUEVO
    <script src="assets/bootstrap/js/jquery.min.js"></script>-->
     ...
     <?php require "includes/convertirma.php"; ?>
	   <?php require "pagoproveedores/scriptPP.php"; ?>
