...
function exportar_calendario_excel($vehiculos_filtrados, $asignaciones, $vencimientos, $colores_vehiculos, $dias_en_mes, $mes_sel, $anio_sel, $meses_nombres, $meses_abrev, $dias_semana_nombres) {
    ...
    echo '<tr><th colspan="'.(3 + $dias_en_mes).'" style="font-size:14pt;font-weight:bold;text-align:center;">CALENDARIO DE VEH&Iacute;CULOS - '.$meses_nombres[$mes_sel].' '.$anio_sel.'</th></tr>';
       ...
       echo '<tr style="height:48px;mso-height-source:userset;">';


    echo '<th style="background:#c9e8e8;font-weight:bold;text-align:center;vertical-align:middle;">No.</th><th style="background:#c9e8e8;font-weight:bold;text-align:center;vertical-align:middle;">Veh&iacute;culo</th><th style="background:#c9e8e8;font-weight:bold;text-align:center;vertical-align:middle;">Placas</th>';
    ...
    for ($d = 1; $d <= $dias_en_mes; $d++) {
        ...
        $dw = date('w', strtotime($fecha));
                    ...
                    $estilo_th = 'font-weight:bold;text-align:center;vertical-align:middle;height:48px;mso-height-source:userset;white-space:normal;';
...
<div class="page-header">
 ...
 <div class="d-flex gap-2 flex-wrap justify-content-end">
  ...
  <button class="btn btn-sm btn-outline-light" style="font-size:14px" onclick="window.print()" hidden>🖨️ IMPRIMIR</button>
