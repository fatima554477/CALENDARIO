...
?>
<input type="text" style="background:#f5eef9" class="form-control" required=""  value="<?php echo $NUMERO_EVENTO; ?>" name="NUMERO_EVENTO" id="NUMERO_EVENTO" placeholder="No. DE EVENTO" readonly="readonly" >
</span>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_VENDEDOR; ?>" name="NOMBRE_VENDEDOR" readonly="readonly">
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_EJECUTIVOEVENTO; ?>" name="NOMBRE_EJECUTIVOEVENTO" readonly="readonly">
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_INGRESO; ?>" name="NOMBRE_INGRESO" readonly="readonly">
 	...
 	<?php if($conexion->variablespermisos('','cierremodifica','ver')=='si'){ ?>
            <tr  style="background:#fcf3cf"> 
				 ...
				 <label  style="width:600px" for="validationCustom03" class="form-label">FECHA BLOQUEO DEL EVENTO:</label></th>
               <td>
...
<!--disabled-->
          ...
          <tr   style="background:#fcf3cf"> 
         <th scope="row"> <label for="validationCustom03" class="form-label">STATUS DEL EVENTO:</label></th>
         <td>


 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $STATUS_EVENTO; ?>" name="STATUS_EVENTO" readonly="readonly">
		 ...
		 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $MONEDAS; ?>" name="MONEDAS" placeholder="MONEDA" <?php if($MONEDAS!=''){echo 'readonly="readonly"'; } ?>>
     ...
     <div class="input-group mb-3"> <span class="input-group-text">$</span> <input type="text"   style="width:400px;height:40px;background:#f5eef9"  id=""  value="<?php echo number_format($CANTIDAD_PORCENTAJEV,2,'.',',');  ?>" name="CANTIDAD_PORCENTAJEV" class=""      placeholder=" MONTO TOTAL COTIZADO DEL EVENTO" <?php if($CANTIDAD_PORCENTAJEV>0.01){echo 'readonly="readonly"';} ?>>
       ...
       <th><label for="validationCustom02" class="form-label"> NOMBRE FISCAL O RAZÓN SOCIAL DE LA EMPRESA (CLIENTE):</label></th>
        <td>
		 ...
		 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_FISCAL_EVENTO; ?>" name="NOMBRE_FISCAL_EVENTO" placeholder="NOMBRE FISCAL DE LA EMPRESA (CLIENTE)" <?php if($NOMBRE_FISCAL_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
		 ...
		 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_COMERCIAL_EVENTO; ?>" name="NOMBRE_COMERCIAL_EVENTO" placeholder="NOMBRE COMERCIAL DE LA EMPRESA (CLIENTE)" <?php if($NOMBRE_COMERCIAL_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_EVENTO; ?>" name="NOMBRE_EVENTO" placeholder="NOMBRE DEL EVENTO" <?php if($NOMBRE_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="tot" required=""  value="<?php echo $NOMBRE_CORTO_EVENTO; ?>" name="NOMBRE_CORTO_EVENTO" placeholder="NOMBRE CORTO DEL EVENTO" <?php if($NOMBRE_CORTO_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NOMBRE_CONTACTO_EVENTO; ?>" name="NOMBRE_CONTACTO_EVENTO" placeholder="NOMBRE DEL CONTACTO CLIENTE 1" <?php if($NOMBRE_CONTACTO_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
         <tr style="background: #efdcf0">
         <th scope="row"> <label for="validationCustom03" class="form-label">CÉLULAR DEL CONTACTO CLIENTE:</label></th>
         <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $CELULAR_CONTACTO_1; ?>" name="CELULAR_CONTACTO_1" placeholder="CELULAR DEL CONTACTO CLIENTE 1" <?php if($CELULAR_CONTACTO_1!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $CORREO_CONTACTO_1; ?>" name="CORREO_CONTACTO_1" placeholder="CORREO DEL CONTACTO CLIENTE 1" <?php if($CORREO_CONTACTO_1!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
         <tr style="background: #efdcf0">  
         ...
         <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $AREA_CONTACTO_CLIENTE; ?>" name="AREA_CONTACTO_CLIENTE"placeholder="AREA DEL CONTACTO CLIENTE 1" <?php if($AREA_CONTACTO_CLIENTE!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $OBSERVACIONES_1; ?>" name="OBSERVACIONES_1" placeholder="OBSERVACIONES 1" <?php if($OBSERVACIONES_1!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
...
<th scope="row"> <label  style="width:300px" for="validationCustom03" class="form-label">PAÍS DONDE SE LLEVARA A CABO EL EVENTO:</label></th>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $PAIS_DEL_EVENTO; ?>" name="PAIS_DEL_EVENTO"placeholder="PAIS DEL EVENTO" <?php if($PAIS_DEL_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
         ...
         <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $CIUDAD_DEL_EVENTO; ?>" name="CIUDAD_DEL_EVENTO" placeholder="CIUDAD DONDE SE LLEVARA A CABO EL EVENTO" <?php if($CIUDAD_DEL_EVENTO!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HOTEL_LUGAR; ?>" name="HOTEL_LUGAR"placeholder="HOTEL O LUGAR" <?php if($HOTEL_LUGAR!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
         <tr style="background:#fcf3cf">      
         ...
         <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $NUMERO_DE_PERSONAS; ?>" name="NUMERO_DE_PERSONAS"placeholder="NUMERO DE PERSONAS" <?php if($NUMERO_DE_PERSONAS!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_INICIO_EVENTO; ?>" name="FECHA_INICIO_EVENTO"placeholder="DIA DE INICIO DEL EVENTO" <?php if($FECHA_INICIO_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
         ...
         <td ><input type="time" style="background:#f5eef9" class="form-control" required=""  value="<?php echo $NOMBRE_COMERCIAL; ?>" name="NOMBRE_COMERCIAL" placeholder="HORA DE INICIO DEL EVENTO" <?php if($NOMBRE_COMERCIAL!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_FINAL_EVENTO; ?>" name="FECHA_FINAL_EVENTO" placeholder="FECHA FINAL DEL EVENTO" <?php if($FECHA_FINAL_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
 ...
 <input type="time" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HORA_TERMINO_EVENTO; ?>" name="HORA_TERMINO_EVENTO"placeholder="HORA DE TERMINO EVENTO" <?php if($HORA_TERMINO_EVENTO!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
		 <tr style="background:#fcf3cf"> 
         ...
         <td><input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_LLEGADA_STAFF; ?>" name="FECHA_LLEGADA_STAFF" placeholder="DIA DE LLEGADA DEL STAFF" <?php if($FECHA_LLEGADA_STAFF!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
 ...
 <input type="time" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HORA_LLEGADA_STAFF; ?>" name="HORA_LLEGADA_STAFF" placeholder="HORA DE TERMINO EVENTO" <?php if($HORA_LLEGADA_STAFF!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
 ...
 <input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_REGRESO_STAFF; ?>" name="FECHA_REGRESO_STAFF" placeholder="FECHA DE REGRESO DEL STAFF" <?php if($FECHA_REGRESO_STAFF!=''){echo 'readonly="readonly"'; } ?>>
 </div>
 </td>
         </tr>
          <tr style="background:#fcf3cf">    
         ...
         <td><input type="time" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HORA_REGRESO_STAFF; ?>" name="HORA_REGRESO_STAFF" placeholder="HORA DE REGRESO DEL STAFF" <?php if($HORA_REGRESO_STAFF!=''){echo 'readonly="readonly"'; } ?>></td>
         </tr>
		...
		<td><select class="form-select mb-3" aria-label="Default select example" style="background:#f5eef9" id="validationCustom02" required="" name="MATERIAL_EQUIPO_BODEGA" <?php if($MATERIAL_EQUIPO_BODEGA=='SI' or $MATERIAL_EQUIPO_BODEGA=='NO'){$DESHABILITAR = 'disabled';}?>>
                         <option selected=""  <?php echo $DESHABILITAR; ?>>SELECCIONA UNA OPCION</option>
        ...
        <td><input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_INICIO_MONTAJE; ?>" name="FECHA_INICIO_MONTAJE" placeholder="FECHA DE INICIO DE MONTAJE" <?php if($FECHA_INICIO_MONTAJE!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
		<tr style="background:#fcf3cf"> 
        <th scope="row"> <label for="validationCustom03" class="form-label">HORA DE INICIO DE MONTAJE:</label></th>
        <td><input type="time" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HORA_INICIO_MONTAJE; ?>" name="HORA_INICIO_MONTAJE" placeholder="HORA DE INICIO DE MONTAJE" <?php if($HORA_INICIO_MONTAJE!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
        <tr style="background:#fcf3cf"> 
        <th scope="row"> <label for="validationCustom03" class="form-label">FECHA DE DESMONTAJE:</label></th>
        <td><input type="date" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $FECHA_DESMONTAJE; ?>" name="FECHA_DESMONTAJE" placeholder="FECHA DE DESMONTAJE" <?php if($FECHA_DESMONTAJE!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
		<tr style="background:#fcf3cf"> 
        <th scope="row"> <label for="validationCustom03" class="form-label">HORA DE INICIO DE DESMONTAJE:</label></th>
        <td><input type="time" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $HORA_DESMONTAJE; ?>" name="HORA_DESMONTAJE" placeholder="HORA DE INICIO DE DESMONTAJE" <?php if($HORA_DESMONTAJE!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
        <tr style="background:#fcf3cf"> 
        <th scope="row"> <label for="validationCustom03" class="form-label">LUGAR DE MONTAJE Y DESMONTAJE:</label></th>
        <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $LUGAR_MONTAJE; ?>" name="LUGAR_MONTAJE" placeholder="LUGAR DE MONTAJE Y DESMONTAJE" <?php if($LUGAR_MONTAJE!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
	...
	<p><input class="form-control form-control-sm" id="ARCHIVO_RELACIONADO_MONTAJE" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('ARCHIVO_RELACIONADO_MONTAJE');"  VALUE="<?php echo $ARCHIVO_RELACIONADO_MONTAJE; ?>" required /></p>
    ...
    ?></div>				 
        ...
        <td><input type="text" style="background:#f5eef9" class="form-control" id="validationCustom03" required=""  value="<?php echo $SERVICIO_OTORGAR; ?>" name="SERVICIO_OTORGAR" placeholder="SERVICIOS PARA OTORGAR" <?php if($SERVICIO_OTORGAR!=''){echo 'readonly="readonly"'; } ?>></td>
        </tr>
  ...
  <p><input class="form-control form-control-sm" id="SUBIR_COTIZACION" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('SUBIR_COTIZACION');"  VALUE="<?php echo $SUBIR_COTIZACION; ?>" required /></p>
...
?></div>				 
  ...
  <p>Suelta aquí o busca tu archivo</p>
  <p><input class="form-control form-control-sm" id="SUBIR_ORDEN_COMPRA" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('SUBIR_ORDEN_COMPRA');"  VALUE="<?php echo $SUBIR_ORDEN_COMPRA; ?>" required /></p>
...
?></div>				 
  ...
  <p>Suelta aquí o busca tu archivo</p>
  <p><input class="form-control form-control-sm" id="SUBIR_CONTRATO_FIRMADO" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('SUBIR_CONTRATO_FIRMADO');"  VALUE="<?php echo $SUBIR_CONTRATO_FIRMADO; ?>" required /></p>
...
?></div>				 
  ...
  <p>Suelta aquí o busca tu archivo</p>
  <p><input class="form-control form-control-sm" id="SUBIR_COTIZACION_FIRMADA" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('SUBIR_COTIZACION_FIRMADA');"  VALUE="<?php echo $SUBIR_COTIZACION_FIRMADA; ?>" required /></p>
...
<p>Suelta aquí o busca tu archivo</p>
<p><input class="form-control form-control-sm" id="LOGO_CLIENTE" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('LOGO_CLIENTE');"  VALUE="<?php echo $LOGO_CLIENTE; ?>" required /></p>
...
<p>Suelta aquí o busca tu archivo</p>
<p><input class="form-control form-control-sm" id="IMAGEN_EVENTO" type="text" style="background:#f5eef9" onkeydown="return false" onclick="file_explorer('IMAGEN_EVENTO');"  VALUE="<?php echo $IMAGEN_EVENTO; ?>" required /></p>
