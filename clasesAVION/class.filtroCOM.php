...
define("__ROOT1__", dirname(dirname(__FILE__)));
	...
	include_once (__ROOT1__."/../comprobacion/class.epcinnPP.php");
...
echo $sql="SELECT $campos , 07COMPROBACION.id as 07COMPROBACIONid FROM $tables LEFT JOIN $tables2 $sWhere $sWhere3 LIMIT $offset,$per_page";
		...
		*/
		...
		$query=$this->mysqli->query($sty);
		 $sty="SELECT $campos , 07COMPROBACION.id as 07COMPROBACIONid  FROM  $tables LEFT JOIN $tables2  $sWhere $sWhere3 ";
		$nums_row=$this->countAll($sty);
		//Set counter
