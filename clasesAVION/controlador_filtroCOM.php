...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"MONTO_TOTAL_COTIZACION_ADEUDO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">MONTO TOTAL DE LA<br> COTIZACIÓN O DEL ADEUDO</th>
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"MONTO_FACTURA",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">MONTO DE LA FACTURA</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"MONTO_DEPOSITAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">MONTO A DEPOSITAR</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"BANCO_ORIGEN",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8">NUMERO DE TARJETA</th>
<?php } ?><?php 
...
<td style="background:#c9e8e8"><input type="text" class="form-control" id="RAZON_SOCIAL" value="<?php 
...
<?php } ?>
<?php  
if($database->plantilla_filtro($nombreTabla,"MONTO_TOTAL_COTIZACION_ADEUDO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="MONTO_TOTAL_COTIZACION_ADEUDO" value="<?php 
...
<?php } ?>
<?php  
if($database->plantilla_filtro($nombreTabla,"PFORMADE_PAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="PFORMADE_PAGO" value="<?php 
echo $PFORMADE_PAGO; ?>"></td>
<?php } ?>
<?php  
if($database->plantilla_filtro($nombreTabla,"FECHA_A_DEPOSITAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="date" class="form-control" id="FECHA_A_DEPOSITAR" value="<?php 
echo $FECHA_A_DEPOSITAR; ?>"></td>
<?php } ?>
<?php  
if($database->plantilla_filtro($nombreTabla,"STATUS_DE_PAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="STATUS_DE_PAGO" value="<?php 
...
<?php } ?><?php  
if($database->plantilla_filtro($nombreTabla,"FOTO_ESTADO_PROVEE11",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="FOTO_ESTADO_PROVEE11" value="<?php 
...
<?php /*termina copiar y terminaA4*/ ?>
		...
		<tr>
<td><?php echo $row["07COMPROBACIONid"]; $colspan += 1;?></td>
...
$totales2 = 'si';
	...
	if( strlen($row['UUID'])<1){
		echo  number_format($porfalta2 * 1.46 , 2, '.', ',');
		$PorfaltaDeFactura12 += $porfalta2 * 1.46 ;
	}
		?></td>
...
<input type="button" name="view" value="MODIFICAR" id="<?php echo $row["07COMPROBACIONid"]; ?>" class="btn btn-info btn-xs view_dataPAGOPROVEEmodifica22" /></td>
<td>
