...
if($database->plantilla_filtro($nombreTabla,"NUMERO_CONSECUTIVO_PROVEE",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">NÚMERO CONSECUTIVO<br> DE PAGO A PROVEEDORES</th>
<?php } ?><?php 
...
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"MONTO_TOTAL_COTIZACION_ADEUDO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">IVA</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"MONTO_PROPINA",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">TUA</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"FECHA_A_DEPOSITAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">FECHA DE PAGO</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"BANCO_ORIGEN",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">NÚMERO DE TARJETA</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"FECHA_TPROGRAPAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">FECHA DE TERMINACIÓN<BR> DE LA PROGRAMACIÓN:</th>
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"NUMERO_EVENTOFIJO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">NÚMERO DE EVENTO (FIJO)<BR> PARA PROGRAMACIÓN</th>
<?php } ?><?php 
...
<?php } ?><?php 
if($database->plantilla_filtro($nombreTabla,"POLIZA_NUMERO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">POLIZA NÚMERO</th>
<?php } ?><?php 
...
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"tipo_documento",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">tipo documento</th>
<?php } ?>
...
<?php 
if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_PDF1",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> FACTURA (FORMATO PDF)</th>
<?php } ?>

<?php 
if($database->plantilla_filtro($nombreTabla,"FOTO_ESTADO_PROVEE11",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">MACH CON EL ESTADO DE CUENTA</th>
<?php } ?>



<?php 
if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_ARCHIVO_1",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> ARCHIVO RELACIONADO<BR> A ESTE GASTO</th>
<?php } ?>
<?php 
...
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"COMPLEMENTOS_PAGO_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">COMPLEMENTOS DE PAGO (FORMATO PDF)</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"COMPLEMENTOS_PAGO_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">COMPLEMENTOS DE PAGO (FORMATO XML)</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"CANCELACIONES_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> CANCELACIONES (FORMATO PDF)</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"CANCELACIONES_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> CANCELACIONES (FORMATO XML)</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_DE_COMISION_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> FACTURA DE <BR>COMISIÓN DESCONTADA PDF</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_DE_COMISION_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> FACTURA DE <BR>COMISIÓN DESCONTADA XML</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"CALCULO_DE_COMISION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center">CALCULO<BR> DE COMISIÓN</th>
<?php } ?>

<?php 
if($database->plantilla_filtro($nombreTabla,"COMPROBANTE_DE_DEVOLUCION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> COMPROBANTE DE <BR>DEVOLUCIÓN DE DINERO A EPC</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"NOTA_DE_CREDITO_COMPRA",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#c9e8e8;text-align:center"> NOTA DE <BR>CREDITO DE COMPRA</th>
<?php } ?>
...
<th style="background:#f9f3a1;text-align:center">SUBTOTAL MÁS TUA:</th>
...
<?php } ?><?php  
if($database->plantilla_filtro($nombreTabla,"RAZON_SOCIAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="RAZON_SOCIAL_1AA" value="<?php 
...
<?php } ?><?php  
if($database->plantilla_filtro($nombreTabla,"NUMERO_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"><input type="text" class="form-control" id="NUMERO_EVENTO_1AA" value="<?php 
...
<?php  
if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8"></td>
<?php } ?>
...
<?php /*termina copiar y terminaA4*/ ?>
		...
		$finales=0;
				$totales = 'no';
		foreach ($datos as $key=>$row){$colspan = 0;$colspan2 = 0;?>
		<tr style="text-align:center">
<td><?php echo $row["10tiketsavionid"];$colspan += 1;?></td>
...
<?php  if($database->plantilla_filtro($nombreTabla,"RAZON_SOCIAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['RAZON_SOCIAL'];?></td>
<?php $colspan += 1; } ?>

<?php  if($database->plantilla_filtro($nombreTabla,"RFC_PROVEEDOR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['RFC_PROVEEDOR'];?></td>
<?php $colspan += 1; } ?>

<?php  if($database->plantilla_filtro($nombreTabla,"NUMERO_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['NUMERO_EVENTO'];?></td>
<?php $colspan += 1;  } ?>
...
<?php  if($database->plantilla_filtro($nombreTabla,"MOTIVO_GASTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['MOTIVO_GASTO'];?></td>
<?php $colspan += 1;  } ?>

<?php  if($database->plantilla_filtro($nombreTabla,"CONCEPTO_PROVEE",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['CONCEPTO_PROVEE'];?></td>
<?php $colspan += 1;  } ?>
...
$MONTO_FACTURA12 += $row['MONTO_FACTURA'];
	?><td style="text-align:center"><?php echo number_format($row['MONTO_FACTURA'],2,'.',','); 
$colspan2 += 1;
	?></td>
<?php } ?>
...
?><td style="text-align:center"><?php echo number_format($row['MONTO_TOTAL_COTIZACION_ADEUDO'],2,'.',','); 
$colspan2 += 1;
?></td>
<?php } ?>
...
echo  number_format($row['MONTO_PROPINA'],2,'.',',');
		...
		$subtotaltua = $row['MONTO_FACTURA'] + $row['MONTO_PROPINA'];
...
$MONTO_DEPOSITAR12 += $row['MONTO_DEPOSITAR'];
	?><td style="text-align:center"><?php echo number_format($row['MONTO_DEPOSITAR'],2,'.',','); 
$colspan2 += 1;
	?></td>
<?php } ?>
...
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"PFORMADE_PAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['PFORMADE_PAGO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"FECHA_A_DEPOSITAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_A_DEPOSITAR'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"STATUS_DE_PAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['STATUS_DE_PAGO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"BANCO_ORIGEN",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['BANCO_ORIGEN'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"ACTIVO_FIJO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['ACTIVO_FIJO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"GASTO_FIJO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['GASTO_FIJO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"PAGAR_CADA",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['PAGAR_CADA'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"FECHA_PPAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_PPAGO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"FECHA_TPROGRAPAGO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_TPROGRAPAGO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"NUMERO_EVENTOFIJO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['NUMERO_EVENTOFIJO'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"CLASI_GENERAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['CLASI_GENERAL'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"SUB_GENERAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['SUB_GENERAL'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"MONTO_DE_COMISION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['MONTO_DE_COMISION'];
$colspan2 += 1;?></td>
<?php } ?><?php  if($database->plantilla_filtro($nombreTabla,"POLIZA_NUMERO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td><?php echo $row['POLIZA_NUMERO'];
$colspan2 += 1;?></td>
...
?></td>
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"tipo_documento",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['tipo_documento'];$colspan2 += 1;
?></td>
<?php } ?>
...
<?php  if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_PDF1",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['ADJUNTAR_FACTURA_PDF1']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['ADJUNTAR_FACTURA_PDF1']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>


<?php  if($database->plantilla_filtro($nombreTabla,"FOTO_ESTADO_PROVEE11",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['FOTO_ESTADO_PROVEE11']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['FOTO_ESTADO_PROVEE11']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_ARCHIVO_1",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['ADJUNTAR_ARCHIVO_1']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['ADJUNTAR_ARCHIVO_1']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_COTIZACION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['ADJUNTAR_COTIZACION']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['ADJUNTAR_COTIZACION']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>


<?php  if($database->plantilla_filtro($nombreTabla,"COMPLEMENTOS_PAGO_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['COMPLEMENTOS_PAGO_PDF']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['COMPLEMENTOS_PAGO_PDF']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>
<?php  if($database->plantilla_filtro($nombreTabla,"COMPLEMENTOS_PAGO_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['COMPLEMENTOS_PAGO_XML']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['COMPLEMENTOS_PAGO_XML']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>
<?php  if($database->plantilla_filtro($nombreTabla,"CANCELACIONES_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['CANCELACIONES_PDF']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['CANCELACIONES_PDF']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"CANCELACIONES_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['CANCELACIONES_XML']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['CANCELACIONES_XML']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_DE_COMISION_PDF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['ADJUNTAR_FACTURA_DE_COMISION_PDF']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['ADJUNTAR_FACTURA_DE_COMISION_PDF']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"ADJUNTAR_FACTURA_DE_COMISION_XML",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['ADJUNTAR_FACTURA_DE_COMISION_XML']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['ADJUNTAR_FACTURA_DE_COMISION_XML']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"CALCULO_DE_COMISION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['CALCULO_DE_COMISION']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['CALCULO_DE_COMISION']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"COMPROBANTE_DE_DEVOLUCION",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['COMPROBANTE_DE_DEVOLUCION']==TRUE){
echo "<a target='_blank'  href='includes/archivos/".$row['COMPROBANTE_DE_DEVOLUCION']."'>Visualizar!</a><br/>";
}?></td><?php } $colspan2 += 1;?>

<?php  if($database->plantilla_filtro($nombreTabla,"NOTA_DE_CREDITO_COMPRA",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php if($row['NOTA_DE_CREDITO_COMPRA']==TRUE){
...
<?php  if($database->plantilla_filtro($nombreTabla,"IVA",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
    <td style="text-align:center"><?php echo $row['MONTO_TOTAL_COTIZACION_ADEUDO'];
	 //$colspan2 += 1;
	 ?></td>
<?php } ?>
...
<?php  if($database->plantilla_filtro($nombreTabla,"SUBTOTAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
	...
	$MONTO_FACTURA13 += $row['MONTO_FACTURA'];
	$totales2 = 'si';
	 ?></td>
<?php } ?>
...
<?php  if($database->plantilla_filtro($nombreTabla,"TOTAL_IMPUESTOS_TRASLADADOS",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
	...
	$MONTO_TOTAL_COTIZACION_ADEUDO13 += $row['MONTO_TOTAL_COTIZACION_ADEUDO'];
	$totales2 = 'si';
	?></td>
<?php } ?>
...
<?php 
if($row['MONTO_PROPINA'] == 0 AND $row['MONTO_PROPINA']==0 ){
	$MONTO_PROPINA = ''; $TuaTotalCargos = '';
}ELSE{
$MONTO_PROPINA = number_format($row['MONTO_PROPINA'],2,'.',','); 
$TuaTotalCargos = number_format($row['MONTO_PROPINA'],2,'.',',');
}

?>
    <td style="text-align:center"><?php echo $MONTO_PROPINA;
		$MONTO_PROPINA13 += $row['MONTO_PROPINA'];
	?></td>


	
	<?php  if($database->plantilla_filtro($nombreTabla,"TuaTotalCargos",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
    <td style="text-align:center"><?php 
	echo number_format($row['TuaTotalCargos'] + $subtotaltua ,2,'.',',');
	$TuaTotalCargos12 += $row['TuaTotalCargos']+ $subtotaltua ;
	$totales2 = 'si';
	 ?></td>
<?php } ?> 
...
<?php  if($database->plantilla_filtro($nombreTabla,"total",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
    <td style="text-align:center"><?php echo  number_format($row['MONTO_DEPOSITAR'],2,'.',',');
	$MONTO_DEPOSITAR13 += $row['MONTO_DEPOSITAR'];
	$totales2 = 'si';
	?></td>
<?php } ?>
    <td style="text-align:center"><?php 
...
<td>
<input type="button" name="view" value="MODIFICAR" id="<?php echo $row["10tiketsavionid"]; ?>" class="btn btn-info btn-xs view_dataPAGOPROVEEmodifica" /></td>


<td>
<input type="button" name="view2" value="BORRAR" id="<?php echo $row["10tiketsavionid"]; ?>" class="btn btn-info btn-xs view_dataSBborrarAVION" />
</td>
</tr>
...
<?php if($database->plantilla_filtro($nombreTabla,"SUBTOTAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($MONTO_FACTURA13,2,'.',','); ?></strong></td>
<?php } ?>
...
<?php  if($database->plantilla_filtro($nombreTabla,"TOTAL_IMPUESTOS_TRASLADADOS",$altaeventos,$DEPARTAMENTO)=="si"){  ?>
<td style="text-align:center" ><strong style="font-size:16px" >$<?php echo number_format($MONTO_TOTAL_COTIZACION_ADEUDO13,2,'.',','); ?></strong></td>
<?php } ?>
...
<td style="text-align:center" ><strong style="font-size:16px" >$<?php echo number_format($MONTO_PROPINA13,2,'.',','); ?></strong></td>


<td style="text-align:center" ><strong style="font-size:16px" >$<?php echo number_format($TuaTotalCargos12,2,'.',','); ?></strong></td>
<?php  if($database->plantilla_filtro($nombreTabla,"total",$altaeventos,$DEPARTAMENTO)=="si"){  ?>
<td style="text-align:center" ><strong style="font-size:16px" >$<?php echo number_format($MONTO_DEPOSITAR13,2,'.',','); ?></strong></td>
<?php } ?>
