...
var RAZON_SOCIAL=$("#RAZON_SOCIAL_1AA").val();
var RFC_PROVEEDOR=$("#RFC_PROVEEDOR_1").val();
var NUMERO_EVENTO=$("#NUMERO_EVENTO_1AA").val();
...
var OBSERVACIONES_1=$("#OBSERVACIONES_1_1A").val();
var FECHA_DE_LLENADO=$("#FECHA_DE_LLENADO_1").val();
var hiddenTIKETS1QA=$("#hiddenTIKETS1QA_1").val();
var tipo_documento=$("#tipo_documento_1").val();
...
/*termina copiar y pegar*/
			...
			$("#loaderAVION").fadeIn('slow');
			$.ajax({
				url:'calendariodeeventos2/clasesAVION/controlador_filtro.php',
				type: 'POST',				
				data: parametros,
				 beforeSend: function(objeto){
				$("#loaderAVION").html("Cargando...");
			  },
				success:function(data){
					$(".datos_ajaxAVION").html(data).fadeIn('slow');
					$("#loaderAVION").html("");
				}
			})
		}
