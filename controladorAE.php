...
$ADJUNTO_COMPROBANTEP = $conexion->solocargar("ADJUNTO_COMPROBANTEP");
 ...
 $ADJUNTO_COMPROBANTEP1 = $ADJUNTO_COMPROBANTEP;
    ...
    $NOMBRE_DELINGRESO = isset($_POST["NOMBRE_DELINGRESO"]) ? $_POST["NOMBRE_DELINGRESO"] : "";
...
$nombreingresov = isset($_POST["nombreingresov"])?$_POST["nombreingresov"]:"";
$nombreocupov = isset($_POST["nombreocupov"])?$_POST["nombreocupov"]:"";
