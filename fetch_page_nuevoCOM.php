...
<div id="content">     
			<hr/>
		<strong>	  <p class="mb-0 text-uppercase" ><img src="includes/contraer31.png" id="mostrar46" style="cursor:pointer;"/>
<img src="includes/contraer41.png" id="ocultar46" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;RESUMEN EGRESOS COMPROBACIÓN DE GASTOS</p></strong></div>
...
<!--aqui inicia filtro-->
            ...
            <div class="row text-center" id="loader2" style="position: absolute;top: 140px;left: 50%; background-color: rgb(255 255 128);"></div>
<table width="100%" border="0">
<tr>
<td width="30%" align="center">
	<span>Mostrar</span>
	<select  class="form-select mb-3" id="per_page" onchange="load7(1);">
		...
		<option value="150" <?php if($_REQUEST['per_page']=='150'){echo 'selected';} ?>>150</option>
...
<td width="30%" align="center">					
	<button  class="btn btn-sm btn-outline-success px-5" type="button" onclick="load7(1);" >BUSCAR</button>
</td>
...
<td width="30%" align="center">
    ...
    $encabezado = '<select class="form-select mb-3" id="DEPARTAMENTO2WE" required="" onchange="load7(1);">
...
<?php 
require "clasesCOM/script.filtroCOM.php";
?>