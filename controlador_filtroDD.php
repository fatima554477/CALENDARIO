...
<?php 
    // Verificar si STATUS_CHECKBOX es "no" o null, y UUID está vacío
...
<?php if($totales2 == 'si'){ ?>
<td style="text-align:right;padding-right:45px;" colspan="<?php echo $colspan2 +1; ?>"><strong style="font-size:16px;COLOR: #C70039 ">TOTALES CON Y SIN XML</strong></td>
<?php } ?>
