...
<div  id="pasarpagado2"></div>
	        ...
	        <div id="target29" style="display:block;" class="content2">
        <div class="card">
          <div class="card-body">
      
<!--aqui inicia filtro-->

            <div class="row text-center" id="loaderAVION" style="position: absolute;top: 140px;left: 50%"></div>
<table width="100%" border="0">
<tr>
<td width="20%" align="center">
	<span>Mostrar</span>
	<select  class="form-select mb-3" id="per_page" onchange="loadAVION(1);">
...
<td width="20%" align="center">					
	<button  class="btn btn-sm btn-outline-success px-5" type="button" onclick="loadAVION(1);"  href="javascript:void(0);" >BUSCAR/RESET</button>
</td>
...
<td width="20%" align="center">
	...
	$encabezado = '<select class="form-select mb-3" id="DEPARTAMENTO2WE" required="" onchange="loadAVION(1);">
...
<?php 
require "clasesAVION/script.filtro.php";
?>