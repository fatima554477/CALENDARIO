...
/*termina copiar y pegar*/
			...
			$("#loaderPP").fadeIn('slow');
			$.ajax({
				url:'calendariodeeventos2/clasesTODOSPP/controlador_filtroDD.php',
				type: 'POST',				
				data: parametros,
				 beforeSend: function(objeto){
				$("#loaderPP").html("Cargando...");
			  },
				success:function(data){
					$(".datos_ajaxPP").html(data).fadeIn('slow');
					$("#loaderPP").html("");
				}
			})
		}
